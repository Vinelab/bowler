...
class Producer
{
	 ...
	 */
	public function __construct(Connection $connection, $queueName, $exchangeName, $exchangeType, array $routingKeys = [null], bool $passive = false, bool $durable = true, bool $autoDelete = false, int $deliveryMode = 2)
	{
